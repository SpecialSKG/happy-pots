...
<section class="section swiper-container swiper-slider swiper-slider-2 swiper-slider-3" data-loop="true" data-autoplay="5000" data-simulate-touch="false" data-slide-effect="fade">
    <div class="swiper-wrapper text-sm-left">
        <div class="swiper-slide context-dark" data-slide-bg="<?= base_url() . 'assets/images/slide-1-1920x753.jpg'; ?>">
        ...
        <div class="swiper-slide context-dark" data-slide-bg="<?= base_url() . 'assets/images/slide-2-1920x753.jpg'; ?>">
            <div class="swiper-slide-caption section-md">
                <div class="container">
                    <div class="row">
        ...
        <div class="row row-md row-30">
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="oh-desktop">
                    <!-- Services Terri-->
                    <article class="services-terri wow slideInDown">
                        <div class="services-terri-figure"><img src="<?= base_url() . 'assets/images/menu-4-370x278.jpg'; ?>" alt="" width="370" height="278" />
                        </div>
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="oh-desktop">
                    <!-- Services Terri-->
                    <article class="services-terri wow slideInUp">
                        <div class="services-terri-figure"><img src="<?= base_url() . 'assets/images/menu-5-370x278.jpg'; ?>" alt="" width="370" height="278" />
                        </div>
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="oh-desktop">
                    <!-- Services Terri-->
                    <article class="services-terri wow slideInDown">
                        <div class="services-terri-figure"><img src="<?= base_url() . 'assets/images/menu-6-370x278.jpg'; ?>" alt="" width="370" height="278" />
                        </div>
        ...
        <div class="row row-lg row-30">
            <div class="col-sm-6 col-lg-4 col-xl-3">
                ...
                <article class="product wow fadeInLeft" data-wow-delay=".15s">
                    <div class="product-figure"><img src="<?= base_url() . 'assets/images/product-1-161x162.'; ?>png" alt="" width="161" height="162" />
                    </div>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3">
                ...
                <article class="product wow fadeInLeft" data-wow-delay=".1s">
                    <div class="product-figure"><img src="<?= base_url() . 'assets/images/product-2-161x162.'; ?>png" alt="" width="161" height="162" />
                    </div>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3">
                ...
                <article class="product wow fadeInLeft" data-wow-delay=".05s">
                    <div class="product-figure"><img src="<?= base_url() . 'assets/images/product-3-161x162.'; ?>png" alt="" width="161" height="162" />
                    </div>
                    <div class="product-rating"><span class="mdi mdi-star"></span><span class="mdi mdi-star"></span><span class="mdi mdi-star"></span><span class="mdi mdi-star"></span><span class="mdi mdi-star text-gray-13"></span>
                    </div>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3">
                ...
                <article class="product wow fadeInLeft">
                    <div class="product-figure"><img src="<?= base_url() . 'assets/images/product-4-161x162.'; ?>png" alt="" width="161" height="162" />
                    </div>
                    <div class="product-rating"><span class="mdi mdi-star"></span><span class="mdi mdi-star"></span><span class="mdi mdi-star"></span><span class="mdi mdi-star"></span><span class="mdi mdi-star"></span>
                    </div>
        ...
        <div class="owl-carousel owl-style-12" data-items="1" data-sm-items="2" data-lg-items="3" data-margin="30" data-xl-margin="45" data-autoplay="true" data-nav="true" data-center="true" data-smart-speed="400">
            ...
            <article class="quote-tara">
                <div class="quote-tara-caption">
                    ...
                    <div class="quote-tara-figure"><img src="<?= base_url() . 'assets/images/user-6-115x115.jpg'; ?>" alt="" width="115" height="115" />
                    </div>
                </div>
            ...
            <article class="quote-tara">
                <div class="quote-tara-caption">
                    ...
                    <div class="quote-tara-figure"><img src="<?= base_url() . 'assets/images/user-8-115x115.jpg'; ?>" alt="" width="115" height="115" />
                    </div>
                </div>
            ...
            <article class="quote-tara">
                <div class="quote-tara-caption">
                    ...
                    <div class="quote-tara-figure"><img src="<?= base_url() . 'assets/images/user-7-115x115.jpg'; ?>" alt="" width="115" height="115" />
                    </div>
                </div>
            ...
            <article class="quote-tara">
                <div class="quote-tara-caption">
                    ...
                    <div class="quote-tara-figure"><img src="<?= base_url() . 'assets/images/user-9-115x115.jpg'; ?>" alt="" width="115" height="115" />
                    </div>
                </div>
    ...
    <div class="container-fluid container-inset-0 isotope-wrap">
        <div class="row row-10 gutters-10 isotope" data-isotope-layout="masonry" data-isotope-group="gallery" data-lightgallery="group">
            <div class="col-xs-6 col-sm-4 col-xl-2 isotope-item oh-desktop">
                <!-- Thumbnail Mary-->
                <article class="thumbnail thumbnail-mary thumbnail-mary-2 wow slideInLeft"><a class="thumbnail-mary-figure" href="images/gallery-1-1200x800-original.jpg" data-lightgallery="item"><img src="<?= base_url() . 'assets/images/gallery-1-310x585.'; ?>jpg" alt="" width="310" height="585" /></a>
            ...
            <div class="col-xs-6 col-sm-8 col-xl-4 isotope-item oh-desktop">
                <!-- Thumbnail Mary-->
                <article class="thumbnail thumbnail-mary thumbnail-mary-big wow slideInRight"><a class="thumbnail-mary-figure" href="images/gallery-2-1200x800-original.jpg" data-lightgallery="item"><img src="<?= base_url() . 'assets/images/gallery-2-631x587.'; ?>jpg" alt="" width="631" height="587" /></a>
                    <div class="thumbnail-mary-caption">
                        <div>
            ...
            <div class="col-xs-6 col-sm-4 col-xl-2 isotope-item oh-desktop">
                <!-- Thumbnail Mary-->
                <article class="thumbnail thumbnail-mary thumbnail-mary-2 wow slideInDown"><a class="thumbnail-mary-figure" href="images/gallery-3-1200x800-original.jpg" data-lightgallery="item"><img src="<?= base_url() . 'assets/images/gallery-3-311x289.'; ?>jpg" alt="" width="311" height="289" /></a>
                    <div class="thumbnail-mary-caption">
                        <div>
            ...
            <div class="col-xs-6 col-sm-8 col-xl-4 isotope-item oh-desktop">
                <!-- Thumbnail Mary-->
                <article class="thumbnail thumbnail-mary wow slideInUp"><a class="thumbnail-mary-figure" href="images/gallery-4-1200x800-original.jpg" data-lightgallery="item"><img src="<?= base_url() . 'assets/images/gallery-4-631x289.'; ?>jpg" alt="" width="631" height="289" /></a>
                    <div class="thumbnail-mary-caption">
                        <div>
            ...
            <div class="col-xs-6 col-sm-4 col-xl-2 isotope-item oh-desktop">
                <!-- Thumbnail Mary-->
                <article class="thumbnail thumbnail-mary thumbnail-mary-2 wow slideInUp"><a class="thumbnail-mary-figure" href="images/gallery-5-1200x800-original.jpg" data-lightgallery="item"><img src="<?= base_url() . 'assets/images/gallery-5-311x289.'; ?>jpg" alt="" width="311" height="289" /></a>
                    <div class="thumbnail-mary-caption">
                        <div>
            ...
            <div class="col-xs-6 col-sm-4 col-xl-2 isotope-item oh-desktop">
                <!-- Thumbnail Mary-->
                <article class="thumbnail thumbnail-mary thumbnail-mary-2 wow slideInRight"><a class="thumbnail-mary-figure" href="images/gallery-6-1200x800-original.jpg" data-lightgallery="item"><img src="<?= base_url() . 'assets/images/gallery-6-311x289.'; ?>jpg" alt="" width="311" height="289" /></a>
                    <div class="thumbnail-mary-caption">
                        <div>
            ...
            <div class="col-xs-6 col-sm-4 col-xl-2 isotope-item oh-desktop">
                <!-- Thumbnail Mary-->
                <article class="thumbnail thumbnail-mary thumbnail-mary-2 wow slideInLeft"><a class="thumbnail-mary-figure" href="images/gallery-7-1200x800-original.jpg" data-lightgallery="item"><img src="<?= base_url() . 'assets/images/gallery-7-311x289.'; ?>jpg" alt="" width="311" height="289" /></a>
                    <div class="thumbnail-mary-caption">
                        <div>
