    ...
    <div class="container">
        <div class="row row-60 justify-content-center justify-content-xxl-between">
            ...
            <div class="col-md-9 col-lg-6 position-static index-1">
                <div class="bg-image-right-1 bg-image-right-lg"><img src="<?= base_url() . 'assets/images/our_history-1110x71'; ?>0.jpg" alt="" width="1110" height="710" />
                    ...
                    <div class="box-transform" style="background-image: url(<?= base_url() . 'assets/'; ?>images/our_history-1110x710.jpg);"></div>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="offset-left-xl-70">
                    ...
                    <div class="slick-quote">
                        ...
                        <div class="slick-slider child-carousel" id="child-carousel-5" data-arrows="true" data-for=".carousel-parent" data-items="4" data-sm-items="4" data-md-items="4" data-lg-items="4" data-xl-items="4" data-slide-to-scroll="1">
                            <div class="item"><img class="img-circle" src="<?= base_url() . 'assets/images/team-5-83x83.jpg'; ?>" alt="" width="83" height="83" />
                            </div>
                            <div class="item"><img class="img-circle" src="<?= base_url() . 'assets/images/team-6-83x83.jpg'; ?>" alt="" width="83" height="83" />
                            </div>
                            <div class="item"><img class="img-circle" src="<?= base_url() . 'assets/images/team-7-83x83.jpg'; ?>" alt="" width="83" height="83" />
                            </div>
                            <div class="item"><img class="img-circle" src="<?= base_url() . 'assets/images/team-8-83x83.jpg'; ?>" alt="" width="83" height="83" />
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-xl-7"><img src="<?= base_url() . 'assets/images/wp-say-669x447.jpg"'; ?> alt="" width=" 669" height="447" />
            </div>
        </div>
    </div>
</section>